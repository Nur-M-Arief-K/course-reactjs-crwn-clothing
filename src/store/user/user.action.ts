...
export const emailSignInStart = 
  withMatcher((email: string, password: string): EmailSignInStart =>
...
export const signUpSuccess = 
  withMatcher((user: User, additionalDetails: AdditionalInformation): SignUpSuccess =>
